...
\begin {document}
    ...
    \title {\Huge\bf Sympa \\ \huge\bf Mailing Lists Management Software \\ version 5.2b.2\\}
    \author {
        Serge Aumont,
        Olivier Sala\"un,
...
\item SetuidPerl : this is the default method but might be insecure. If you don't set the \textbf {- -enable\_secure} configure option,
      \file {wwsympa.fcgi} is installed with the SetUID bit set. On most you will need to install the suidperl package.
