...
\begin {document}
    ...
    \title {\Huge\bf Sympa \\ \huge\bf Mailing Lists Management Software \\ version 5.3a.10\\}
    \author {
        Serge Aumont,
        Olivier Sala\"un,
...
\begin {itemize}
	...
	\end {htmlonly}\\
     ...
     \item \lparam {d\_read} \texttt {private-https} 
	\begin {htmlonly}
	  (\htmladdnormallink {view} {http://www.sympa.org/distribution/current/src/etc/scenari/d_read.private-https})
	\end {htmlonly}\\
...
\begin {itemize}
	...
	\end {htmlonly}\\
     ...
     \item \lparam {d\_edit} \texttt {private-https} 
	\begin {htmlonly}
	  (\htmladdnormallink {view} {http://www.sympa.org/distribution/current/src/etc/scenari/d_edit.private-https})
	\end {htmlonly}\\
