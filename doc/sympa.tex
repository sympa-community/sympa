...
\begin {document}
    ...
    \title {\Huge\bf Sympa \\ \huge\bf Mailing Lists Management Software \\ version 5.0b.2\\}
    \author {
        Serge Aumont,
        Olivier Sala\"un,
...
Sympa comes with default configuration files (templates, scenarios,...) that will be installed in the \dir {/home/sympa/bin} directory. 
...
\file {/home/sympa/bin/alias\_manager.pl} works on the alias file as defined in \file {sympa.conf})
...
\begin {quote}
\begin{verbatim}
FastCgiServer /wwsympa.fcgi -processes 3 -idle-timeout 120
.....
