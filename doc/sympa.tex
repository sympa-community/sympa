...
\begin {itemize}
	...
	\item \dir {/usr/local/sympa-os/spool/expire/}\\
...
\subsection {\cfkeyword {queueexpire}}  
	...
	\default {\dir {/usr/local/sympa-os/spool/expire}}
...
\dir {/usr/local/sympa-os/etc/\samplerobot/wws\_templates/},
\dir {/usr/local/sympa-os/etc/\samplerobot/templates/}, 
