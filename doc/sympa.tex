...
\begin {document}
    ...
    \title {\Huge\bf Sympa \\ \huge\bf Mailing Lists Management Software \\ version 5.3a.7\\}
    \author {
        Serge Aumont,
        Olivier Sala\"un,
...
\subsection {\cfkeyword {sendmail\_aliases}} 
	...
	\default {defined by makefile, sendmail\_aliases}
        ...
        Set this parameter to \example {none} if you want to disable alias management in sympa (e.g. if you use \file {virtual\_transport} with Postfix).
