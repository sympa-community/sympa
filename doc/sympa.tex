...
\begin {document}
    ...
    \title {\Huge\bf Sympa \\ \huge\bf Mailing Lists Management Software \\ version 5.3a.3\\}
    \author {
        Serge Aumont,
        Olivier Sala\"un,
...
\begin {itemize}
  ...
  being located in a subdirectory of the \textbf {tt2} directory. \example {/web\_tt2/fr\_FR/helpfile.tt2}
...
A binary version of the config (\file {/usr/local/sympa-sa/expl/\samplerobot/\samplelist/config.bin} is maintained to allow 
