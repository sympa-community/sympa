...
\begin {document}
    ...
    \title {\Huge\bf Sympa \\ \huge\bf Mailing Lists Management Software \\ version 5.1b.1\\}
    \author {
        Serge Aumont,
        Olivier Sala\"un,
...
\begin {itemize}
	...
	\end {htmlonly}\\
     ...
     \item \lparam {unsubscribe} \texttt {o} 
	\begin {htmlonly}
	  (\htmladdnormallink {view} {http://www.sympa.org/distribution/current/src/etc/scenari/unsubscribe.o})
	\end {htmlonly}\\
