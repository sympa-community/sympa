...
\begin {document}
    ...
    \title {\Huge\bf Sympa \\ \huge\bf Mailing Lists Management Software \\ version 4.0.a3\\}
    \author {
        Serge Aumont,
        Olivier Sala\"un,
...
\item purge\_orphan\_bounces()
        ...
        Clean bounces by removing unsuscribed-users archives.
...
\begin {quote}
  \begin{verbatim}
    ...
    ## will be unsuscribed, and listmaster will recieve an email
    Bouncers level 2
    rate :75 Points
