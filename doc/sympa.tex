...
\begin {document}
    ...
    \title {\Huge\bf Sympa \\ \huge\bf Mailing Lists Management Software \\ version 4.0.a9\\}
    \author {
        Serge Aumont,
        Olivier Sala\"un,
...
\begin {itemize}
	...
	restricted to subscribers
     ...
     \item \lparam {send} \texttt {private\_or\_auth} 
	\begin {htmlonly}
	  (\htmladdnormallink {view} {http://listes.cru.fr/sympa/distribution/current/src/etc/scenari/send.private\_or\_auth})
	\end {htmlonly}\\
	Confirmation for non subscribers ; then moderation

     \item \lparam {send} \texttt {private\_or\_auth\_and\_editorkey} 
	\begin {htmlonly}
	  (\htmladdnormallink {view} {http://listes.cru.fr/sympa/distribution/current/src/etc/scenari/send.private\_or\_auth\_and\_editorkey})
	\end {htmlonly}\\
	Confirmation for non subscribers ; then moderation
	...
	Moderated, restricted to subscribers
     ...
     \item \lparam {send} \texttt {p} 
	\begin {htmlonly}
	  (\htmladdnormallink {view} {http://listes.cru.fr/sympa/distribution/current/src/etc/scenari/send.p})
	\end {htmlonly}\\
	Moderated, restricted to subscribers
