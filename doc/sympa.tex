...
\begin {document}
    ...
    \title {\Huge\bf Sympa \\ \huge\bf Mailing Lists Management Software \\ version 4.2b.1\\}
    \author {
        Serge Aumont,
        Olivier Sala\"un,
...
\dir {/home/sympa/locale} directory. Messages have currently been
...
title.cz denní aktualizace seznamu revokací certifikátù
...
\begin {itemize}
	...
	\end {htmlonly}\\
     ...
     \item \lparam {d\_edit} \texttt {e} 
	\begin {htmlonly}
	  (\htmladdnormallink {view} {http://listes.cru.fr/sympa/distribution/current/src/etc/scenari/d_edit.e})
	\end {htmlonly}\\
