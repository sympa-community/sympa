...
one entry per line : the first field is an email address, the second (optional) 
...
If the subscribers file is too big, a timeout may accur with the FastCGI
...
A default topic is hard-coded in \Sympa : \textit {default} ; it has in it
all lists that don't have a topic.
