...
\begin {document}
    ...
    \title {\Huge\bf Sympa \\ \huge\bf Mailing Lists Management Software \\ version 4.0.a1\\}
    \author {
        Serge Aumont,
        Olivier Sala\"un,
...
\begin {itemize}
	...
	files as in the distribution.  \dir {/home/sympa/bin} may be completely
        ...
        templates and scenarii under  \dir {/home/sympa/bin}.

	\item \dir {/home/sympa/bin/etc}\\
	Here \Sympa stores the default versions of what it will otherwise find
	in \dir {/home/sympa/etc} (task models, scenarios, templates and configuration
	...
	page~\pageref {scenarii}. Those scenarii are default scenarii but you may look at
        \dir {/home/sympa/etc/\samplerobot/scenari/} for default scenarii of \samplerobot
        virtual robot and \dir {/home/sympa/expl/\samplelist/scenari} for scenarii
...
CREATE TABLE log_table (
	id			unsigned DEFAULT '0' NOT NULL auto_increment,
	...
	operation_list		varchar (50),
	operation_robot		varchar (60),
	operation_arg		varchar (100),
	operation_status	varchar (100),
	list_subscriber		int,
	PRIMARY KEY (id),
	INDEX (date_operation),	
	INDEX (operation_robot),
	INDEX (robot_list,operation_robot),
	INDEX (email_user)
);
...
The \file {/home/sympa/etc/auth.conf} is organised in paragraphs. Each paragraph coincides with the configuration of 
an ldap directory.
...
\subsection {Definition}
	...
	People are selected through an \index {LDAP filter} defined in a configuration file. This file must have the extension '.ldap'.It is stored in \dir {/home/sympa/etc/search\_filters/}.
...
directory ; your site web templates in \tildedir {/home/sympa/expl/wws\_templates} directory.
...
does not find the file there, it scans \dir {/home/sympa/etc/scenari},
...
These standard scenarii are located in the \dir {/home/sympa/bin/etc/scenari/}
...
Scenarii can also be defined for a particular virtual robot (using directory \dir {/home/sympa/etc/\texttt{<}robot\texttt{>}/scenari}) or for a list ( \dir {/home/sympa/expl/\texttt{<}robot\texttt{>}/\texttt{<}list\texttt{>}/scenari} ).
...
\begin {itemize}
	...
	no conceal
     ...
     \item \lparam {visibility} \texttt {private}
	\begin {htmlonly}
	  (\htmladdnormallink {view} {http://listes.cru.fr/sympa/distribution/current/src/etc/scenari/visibility.private})
	\end {htmlonly}\\
	subscribers
