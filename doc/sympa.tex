...
\begin {document}
    ...
    \title {\Huge\bf Sympa \\ \huge\bf Mailing Lists Management Software \\ version 5.0b.1\\}
    \author {
        Serge Aumont,
        Olivier Sala\"un,
...
\begin {itemize}
	...
	\begin {htmlonly}
	  (\htmladdnormallink {view} {http://listes.cru.fr/sympa/distribution/current/src/etc/scenari/d_read.p})
	\end {htmlonly}\\
...
\begin {itemize}
	...
	\begin {htmlonly}
	  (\htmladdnormallink {view} {http://listes.cru.fr/sympa/distribution/current/src/etc/scenari/d_edit.editor})
	\end {htmlonly}\\
	...
	\begin {htmlonly}
	  (\htmladdnormallink {view} {http://listes.cru.fr/sympa/distribution/current/src/etc/scenari/d_edit.p})
	\end {htmlonly}\\
