...
\begin {document}
    ...
    \title {\Huge\bf Sympa \\ \huge\bf Mailing Lists Management Software \\ version 4.0.a4\\}
    \author {
        Serge Aumont,
        Olivier Sala\"un,
...
The \file {/home/sympa/etc/auth.conf} is organised in paragraphs. Each paragraph describe a authentication 
