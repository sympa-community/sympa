...
\begin {itemize}
	...
	\item \dir {[LOCALEDIR]}\\
	Internationalization directory. It contains message catalogues in the GNU .po format. \Sympa has currently been translated
...
\subsection {\cfkeyword {lang}}   
	...
	catalog (.msg) located in the corresponding \cfkeyword {locale} directory
	will be used.
...
\dir {[LOCALEDIR]} directory. Messages have currently been
