...
<TD>
 ...
 <TD ALIGN="right">
        [IF prev_page]
	  <A HREF="[path_cgi]/reviewbouncing/[list]/[prev_page]/[size]"><IMG SRC="/icons/left.png" BORDER=0 ALT="Elõzõ oldal"></A>
        [ENDIF]
        [IF page]
  	  [page] oldal / [total_page]
        [ENDIF]
        [IF next_page]
	  <A HREF="[path_cgi]/reviewbouncing/[list]/[next_page]/[size]"><IMG SRC="/icons/right.png" BORDER=0ALT="Következõ oldal"></A>
        [ENDIF]
    </TD></TR>
	...
	<INPUT TYPE="submit" NAME="action_resetbounce" VALUE="Kijelöltek hibajegyzékének törlése">
	  ...
	  <A HREF="[path_cgi]/reviewbouncing/[list]/[prev_page]/[size]"><IMG SRC="/icons/left.png" BORDER=0 ALT="Elõzõ oldal"></A>
        ...
        [ENDIF]
        [IF next_page]
	  <A HREF="[path_cgi]/reviewbouncing/[list]/[next_page]/[size]"><IMG SRC="/icons/right.png" BORDER=0 ALT="Következõ oldal"></A>
        [ENDIF]
    </TD></TR>
