...
<TD>
  <FORM METHOD="post" ACTION="[path_cgi]">
    <INPUT TYPE="button" VALUE="Emlékeztetõ elküldése az összes listatagnak" NAME="action_remind" onClick="request_confirm(this.form,'Tényleg szeretnél mind a(z) [total] tagnak emlékeztetõt küldeni levelezõlista tagságukról?')">
 ...
 <TD ALIGN="right">
        [IF prev_page]
	  <A HREF="[path_cgi]/reviewbouncing/[list]/[prev_page]/[size]"><IMG SRC="/icons/left.gif" BORDER=0 ALT="Elõzõ oldal"></A>
        [ENDIF]
        [IF page]
  	  [page] oldal / [total_page]
        [ENDIF]
        [IF next_page]
	  <A HREF="[path_cgi]/reviewbouncing/[list]/[next_page]/[size]"><IMG SRC="/icons/right.gif" BORDER=0ALT="Következõ oldal"></A>
        [ENDIF]
    </TD></TR>
	...
	<INPUT TYPE="submit" NAME="action_resetbounce" VALUE="Kijelöltek hibajegyzékének törlése">
	  ...
	  <A HREF="[path_cgi]/reviewbouncing/[list]/[prev_page]/[size]"><IMG SRC="/icons/left.gif" BORDER=0 ALT="Elõzõ oldal"></A>
        ...
        [ENDIF]
        [IF next_page]
	  <A HREF="[path_cgi]/reviewbouncing/[list]/[next_page]/[size]"><IMG SRC="/icons/right.gif" BORDER=0 ALT="Következõ oldal"></A>
        [ENDIF]
    </TD></TR>
