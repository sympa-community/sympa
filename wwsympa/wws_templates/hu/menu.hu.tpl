...
<TABLE CELLPADDING="2" CELLSPACING="2" WIDTH="100%" BORDER="0">
  ...
  <TD bgcolor="[bg_color]">
<A HREF="[path_cgi]/show_cert" onClick="winhelp=window.open('','wws_help','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,width=600,height=320');winlogin.focus()" TARGET="wws_help"><IMG SRC="[icons_url]/locked.png" align="center" alt="titkosítási információk" border=0></A>
  [ELSE]
  <TD>
  ...
  [IF auth_method=md5]
     ...
     [ENDIF]
     <FONT SIZE=-1><B>Kilépés</B></FONT></A>
     </TD>
  [ELSE]
  ...
  [ELSE]
     ...
     [ENDIF]
       ...
       <FONT SIZE=-1><B>Belépés</B></FONT></A>
      </TD>
  [ENDIF]
    </TR>
  </TABLE>
...
<TABLE CELLPADDING=0 CELLSPACING=0 WIDTH="100%" BORDER=0>
  ...
  [IF may_create_list]
   [IF action=create_list_request]
    <TD NOWRAP BGCOLOR="[selected_color]" ALIGN="center">
        <FONT SIZE=-1 COLOR=[bg_color] ><B>Lista létrehozása</B></FONT>
    </TD>
   [ELSE]
    <TD NOWRAP BGCOLOR="[light_color]"  ALIGN="center">
	 <A HREF="[path_cgi]/create_list_request" ><FONT SIZE=-1><B>Lista létrehozása</B></FONT></A>
    </TD>
   [ENDIF]
  [ENDIF]
  ...
  [IF action=home]
  <TD NOWRAP BGCOLOR="[selected_color]" ALIGN="center"><FONT SIZE=-1 COLOR=[bg_color]><B>Induló oldal</B></FONT></TD>
  [ELSE]
  <TD NOWRAP BGCOLOR="[light_color]" ALIGN="center">
      <A HREF="[path_cgi]/"><FONT SIZE=-1><B>Induló oldal</B></FONT></A>
  </TD>
  [ENDIF]

  [IF action=help]
  <TD NOWRAP BGCOLOR="[selected_color]" ALIGN="center"><FONT SIZE=-1 COLOR=[bg_color]><B>Súgó</B></FONT></TD>
  [ELSE]
  <TD NOWRAP BGCOLOR="[light_color]" ALIGN="center">
      <A HREF="[path_cgi]/help" ><FONT SIZE=-1><B>Súgó</B></FONT></A>
  </TD>
  [ENDIF]
</TR>
</TABLE>
