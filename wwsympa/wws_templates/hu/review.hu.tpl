...
<TABLE WIDTH="100%" BORDER="0">
  ...
  <TD NOWRAP>
   ...
   <TD>
   [IF prev_page]
    <A HREF="[path_cgi]/review/[list]/[prev_page]/[size]/[sortby]"><IMG SRC="[icons_url]/left.png" BORDER=0 ALT="Elõzõ oldal"></A>
   [ENDIF]
   [IF page]
     Oldalak [page] / [total_page]
   [ENDIF]
   [IF next_page]
     <A HREF="[path_cgi]/review/[list]/[next_page]/[size]/[sortby]"><IMG SRC="[icons_url]/right.png" BORDER="0" ALT="Következõ oldal"></A>
   [ENDIF]
  [ENDIF]
  </TD></TR>
  </TABLE>
