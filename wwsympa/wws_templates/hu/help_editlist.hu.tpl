...
<DD>
[IF p->NAME=add]
  Jogosultság listatag felvételére (ADD parancs).
[ELSIF p->NAME=anonymous_sender]
  Rejtse el az üzenet beküldõjének e-mail címét.
  A megadott e-mail cím kerül a feladó helyére.
[ELSIF p->NAME=archive]
  Jogosultság az archívum olvasásához és annak frissítéséhez.
[ELSIF p->NAME=owner]
  ...
  egy tulajdonosa lehet a listának; e-mail címet weben keresztül nem lehet megváltoztatni.
[ELSIF p->NAME=editor]
...
BIZ: Ha a lista moderált, akkor az a szerkesztõ, aki legelõször dönt a levél
