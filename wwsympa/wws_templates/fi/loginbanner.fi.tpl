...
<BR>
[IF password_sent]
  Salasanasi on lähetetty osoitteeseen [init_email].<BR>
  Tarkista postisi ja anna salasana alle.
  <BR><BR>
[ENDIF]

[IF action=loginrequest]
 Sinun täytyy kirjautua päästäksesi WWSympaan tai suorittamaan oikeutettuja
 toimontoja (vaatii email osoitteen).
[ELSE]
 Suurin osa ominaisuuksista vaatii email osoitteem. Jotkut osoitteet ovat piilossa
 tunnistamattomilta henkilöiltä.<BR>
 Jos haluat käyttää ominaisuuksia, sinun tulee tunnistautua ensin.<BR>
[ENDIF]
...
<TABLE border=0><TR>
<TD>
<I>Jos et ole saanut salasanaa palvelimelta tai et muista sitä : </I>
</TD><TD>
<TABLE CELLPADDING="2" CELLSPACING="2" WIDTH="100%" BORDER="0">
  ...
  <TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="2">
     ...
     <FONT SIZE=-1><B>Lähetä salasana</B></FONT></A>
     </TD>
    </TR>
  </TABLE>
</TR>
