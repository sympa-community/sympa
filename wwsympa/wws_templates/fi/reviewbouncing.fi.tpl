...
<TD>
  <FORM METHOD="post" ACTION="[path_cgi]">
    <INPUT TYPE="button" VALUE="Muistuta kaikkia tilaajia" NAME="action_remind" onClick="request_confirm(this.form,'Haluatko varmasti lähettää tilausmuistutuksen kaikille [total] tilaajille')">
 ...
 <TD ALIGN="right">
    ...
    <TR><TD><INPUT TYPE="submit" NAME="action_resetbounce" VALUE="Nollaa virheet valituilla käyttäjillä">
    </TD></TR>
    </TABLE>
    ...
    <TR><TD ALIGN="left" NOWRAP>
      [IF is_owner]
        <BR>
        <INPUT TYPE="submit" NAME="action_del" VALUE="Poista valitut käyttäjät">
        <INPUT TYPE="checkbox" NAME="quiet"> hiljainen
	<INPUT TYPE="submit" NAME="action_resetbounce" VALUE="Nollaa virheet valituilta käyttäjiltä">
      [ENDIF]
