...
[IF !group]
Voit valita ryhm‰n parametreja joita muuttaa : <UL>
<LI><A HREF="[path_cgi]/edit_list_request/[list]/description" >Listan m‰‰ritykset</A>
<LI><A HREF="[path_cgi]/edit_list_request/[list]/sending" >L‰hetys/vastaanotto asetukset</A>
<LI><A HREF="[path_cgi]/edit_list_request/[list]/command" >Oikeudet</A>
<LI><A HREF="[path_cgi]/edit_list_request/[list]/archives" >Arkistot</A>
<LI><A HREF="[path_cgi]/edit_list_request/[list]/bounces" >V‰‰rien osoitteiden hallinta</A>
<LI><A HREF="[path_cgi]/edit_list_request/[list]/data_source" >Data l‰hteiden asetukset</A>
<LI><A HREF="[path_cgi]/edit_list_request/[list]/other" >Sekalaiset</A>
</UL>
[ELSE]
...
[FOREACH p IN param]
 [IF p->may_edit<>hidden]
  ...
  <A HREF="[path_cgi]/help/editlist#[p->name]" onClick="window.open('','wws_help','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,width=400,height=200')" TARGET="wws_help"  ><FONT SIZE="-1">Apua</FONT></A>
  </TH></TR></TABLE>
  ...
  [IF p->default=1]
    <FONT COLOR="[bg_color]"><B>oletus</B></FONT>
  [ENDIF]
...
<INPUT TYPE="submit" NAME="action_edit_list" VALUE="P‰ivit‰">
</FORM>
[ENDIF]
