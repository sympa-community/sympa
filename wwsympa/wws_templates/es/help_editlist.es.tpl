...
<DD>
[IF p->NAME=add]
  Privilegio para añadir (comando ADD) un subscriptor a la lista
...
[ELSIF p->NAME=owner]
  Los propietarios administran los subscriptores. Ellos pueden revisar los subscriptores, añadir y borrar direcciones de la lista de correo. Si usted es propietario privilegiado de una lista de correo, puede añadir otros propietarios a la misma. 
[ELSIF p->NAME=editor]
