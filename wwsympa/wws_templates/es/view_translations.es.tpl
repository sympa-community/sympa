...
<TH  ALIGN="left"><FONT COLOR="[bg_color]">Acciones</TH>
...
[FOREACH file IN tpl]
  ...
  [FOREACH translation IN file]
      [IF translation=none]
	<TD BGCOLOR="[bg_color]"><A HREF="[path_cgi]/translate/[file->NAME]/[translation->NAME]">Ejecutar!</A></TD>
      [ELSE]
	<TD><FONT COLOR="[bg_color]">traducida</FONT></TD>
      [ENDIF]
  [END]
  </TR>
[END]
