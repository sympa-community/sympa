...
<!-- begin -->
     ...
     <TD BGCOLOR="#330099" VALIGN="top">
      ...
      [IF action=info]
        <TD WIDTH=100% BGCOLOR="#3366cc" NOWRAP align=right>
           <font color="#ffffff" size=-1><b>邮递表信息</b></font>
        </TD>
      [ELSE]
 ...
 <TR><!-- for listmaster owner and editor -->
  ...
  <TD WIDTH="70" COLSPAN="2" NOWRAP align=right>
   ...
   [IF action=admin]
        <TD WIDTH="100%" BGCOLOR="#3366cc" NOWRAP align=right><font color="#ffffff" size=-1><b>邮递表管理</b></font></TD>
   [ELSIF action_type=admin]
        <TD WIDTH="100%" BGCOLOR="#3366cc" NOWRAP align=right>
        <b>
         <A HREF="[path_cgi]/admin/[list]" ><FONT COLOR="#ffffff" SIZE="-1">邮递表管理</FONT></A>
        </b>
        </TD>
   [ELSE]
        <TD WIDTH="100%" BGCOLOR="#ccccff" NOWRAP align=right>
    ...
    <TR>
     <TD BGCOLOR="#330099" VALIGN="top">
      ...
      [IF action=suboptions]
        <TD WIDTH="100%" BGCOLOR="#3366cc" NOWRAP align=right><font color="#ffffff" size=-1><b>订阅者选项</b></font></TD>
      [ELSE]
        <TD WIDTH="100%" BGCOLOR="#ccccff" NOWRAP align=right>
        <font size=-1><b>
 ...
 <TR>
  ...
  <TD WIDTH="70" COLSPAN="2" NOWRAP align=right>
   ...
   [IF action=subrequest]
        <TD WIDTH="100%" BGCOLOR="#3366cc" NOWRAP align=right><font color="#ffffff" size=-1><b>订阅</b></font></TD>
   [ELSE]
        <TD WIDTH="100%" BGCOLOR="#ccccff" NOWRAP align=right>
   [IF may_subscribe=1]
        <font size=-1><b>
   ...
   [ELSE]
	<font size=-1 COLOR="#ffffff"><b>订阅</b></font>
   [ENDIF]
        </TD>
   [ENDIF]
 ...
 <TR>
  ...
  <TD WIDTH="70" COLSPAN="2" NOWRAP align=right>
   ...
   [IF action=arc]
        <TD WIDTH="100%" BGCOLOR="#3366cc" NOWRAP align=right>
          <font size=-1 COLOR="#ffffff"><b>归档</b></font>
	</TD>
  ...
  <TD WIDTH="70" COLSPAN="2" NOWRAP align=right>
   <TABLE  WIDTH="100%" BORDER="0" CELLPADDING="1" CELLSPACING="2">
    ...
    [ELSE]
      ...
      [ELSE]
        <TD WIDTH="100%" BGCOLOR="#ccccff" NOWRAP align=right>
         <font size=-1 COLOR="#ffffff"><b>共享页面</b></font>
        </TD>
      [ENDIF]
    [ENDIF]
