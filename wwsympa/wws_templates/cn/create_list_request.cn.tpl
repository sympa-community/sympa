...
<TABLE>
 <TR>
   ...
   <TD><img src="[icons_url]/unknown.png" alt="邮递表名；注意，不是它的地址!"></TD>
 </TR>
 
 <TR>
   <TD NOWRAP><B>所有者:</B></TD>
   <TD><I>[user->email]</I></TD>
   <TD><img src="[icons_url]/unknown.png" alt="您是这个邮递表的特权所有者"></TD>
 </TR>
 ...
 <TR>
  ...
  [END]
    ...
    <TD valign=top><img src="[icons_url]/unknown.png" alt="邮递表类型是参数集配置。可以在邮递表创建后编辑参数"></TD>
 </TR>
 <TR>
   <TD NOWRAP><B>主题:</B></TD>
   <TD><INPUT TYPE="text" NAME="subject" SIZE=60 VALUE="[saved->subject]"></TD>
   <TD><img src="[icons_url]/unknown.png" alt="这是邮递表的主题"></TD>
 </TR>
 <TR>
   <TD NOWRAP><B>话题:</B></TD>
 ...
 <TR>
   ...
   <TD valign=top><img src="[icons_url]/unknown.png" alt="几行对邮递表的描述文字"></TD>
 </TR>
