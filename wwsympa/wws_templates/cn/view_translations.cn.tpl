...
<TH  ALIGN="left"><FONT COLOR="--BG_COLOR--">操作</TH>
...
[FOREACH file IN tpl]
  ...
  [FOREACH translation IN file]
      [IF translation=none]
	<TD BGCOLOR="--BG_COLOR--"><A HREF="[path_cgi]/translate/[file->NAME]/[translation->NAME]">进行</A></TD>
      [ELSE]
	<TD><FONT COLOR="--BG_COLOR--">完成翻译</FONT></TD>
      [ENDIF]
  [END]
  </TR>
[END]
