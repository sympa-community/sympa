...
<TABLE>
 <TR>
   ...
   <TD><img src="[icons_url]/unknown.png" alt="jméno konference ; ne její adresu!"></TD>
 </TR>
 
 <TR>
   <TD NOWRAP><B>Vlastník:</B></TD>
   <TD><I>[user->email]</I></TD>
   <TD><img src="[icons_url]/unknown.png" alt="Jste vlastníkem konference"></TD>
 </TR>
 ...
 <TR>
  ...
  [END]
    ...
    <TD valign=top><img src="[icons_url]/unknown.png" alt="Typ konference je pøednastavený profil. Parametry se budou moci mìnit, a¾ se konference vytvoøí"></TD>
 </TR>
 <TR>
   <TD NOWRAP><B>Pøedmìt:</B></TD>
   <TD><INPUT TYPE="text" NAME="subject" SIZE=60 VALUE="[saved->subject]"></TD>
   <TD><img src="[icons_url]/unknown.png" alt="Téma konference"></TD>
 </TR>
 <TR>
   ...
   <TD valign=top><img src="[icons_url]/unknown.png" alt="Klasifikace konference v adresáøi"></TD>
 </TR>

 <TR>
   <TD valign=top NOWRAP><B>Popis:</B></TD>
   <TD><TEXTAREA COLS=60 ROWS=10 NAME="info">[saved->info]</TEXTAREA></TD>
   <TD valign=top><img src="[icons_url]/unknown.png" alt="Nìkolik øádkù popisujících konferenci"></TD>
 </TR>
