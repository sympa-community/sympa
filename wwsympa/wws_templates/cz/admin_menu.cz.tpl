...
<!-- begin admin_menu.us.tpl -->
	...
	[IF is_listmaster]
        ...
        [ENDIF]
       [ELSE]
        <A HREF="[path_cgi]/close_list/[list]" onClick="request_confirm_link('[path_cgi]/close_list/[list]', 'Opravdu chcete uzavøít konferenci [list] ?'); return false;"><FONT size=-1><b>Uzavøít konferenci</b></font></A>
       [ENDIF]
    </TD>
    <TD BGCOLOR="[light_color]" ALIGN="CENTER">
	[IF shared=none]
