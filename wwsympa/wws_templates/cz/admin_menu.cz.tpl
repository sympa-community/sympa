...
<!-- begin admin_menu.us.tpl -->
	...
	<FONT COLOR="#ffffff"><b>Panel správy konference</b></font>
    </TD>
    </TR>
    <TR>
    ...
    [IF action=review]
    <TD BGCOLOR="#3366cc" ALIGN="CENTER">
       <FONT size="-1" COLOR="#ffffff"><b>Èlenové</b></FONT>
    </TD>
    [ELSE]
    <TD BGCOLOR=#ccccff ALIGN=CENTER>
       [IF is_owner]
    ...
    <TD BGCOLOR="#3366cc" ALIGN="CENTER">
       <FONT size="-1" COLOR="#ffffff"><b>Vrácené zprávy</b></FONT>
    </TD>
    [ELSE]
    <TD BGCOLOR="#ccccff" ALIGN="CENTER">
       [IF is_owner]
    ...
    [IF action=modindex]
    <TD BGCOLOR="#3366cc" ALIGN="CENTER">
       <FONT size="-1" COLOR="#ffffff"><b>Moderování</b></FONT>
    </TD>
    [ELSE]
       [IF is_editor]
       <TD BGCOLOR="#ccccff" ALIGN=CENTER>
    ...
    [IF action=editfile]
    <TD BGCOLOR="#3366cc" ALIGN="CENTER">
       <FONT size="-1" COLOR="#ffffff"><b>Úpravy</b></FONT>
    </TD>
    [ELSE]
    <TD BGCOLOR="#ccccff" ALIGN="CENTER">
       [IF is_owner]
