...
<FORM ACTION="[path_cgi]" METHOD=POST>
    ...
    <TABLE BORDER=0 CELLPADDING=10>
      <TR VALIGN="top">
        <TD COLSPAN=2 NOWRAP>
    	<FONT COLOR="[dark_color]"><CENTER><B>Modul testu scénáøe</b></CENTER></FONT><BR>
        </TD>
      </TR>
      <TR>
        <TD>Jméno scénáøe</TD>
