...
[IF action=search]
<BR>nalezeno [occurrence] výskyt(ù)<BR>
[IF too_many_select]
Výbìr pøíli¹ rozsáhlý, nelze jej zobrazit
[ENDIF]
[ENDIF]
</FORM>
</TD>
...
<TABLE WIDTH="100%" BORDER="0">
  ...
  <TD NOWRAP>
   ...
   <TD>
   [IF prev_page]
    <A HREF="[path_cgi]/review/[list]/[prev_page]/[size]/[sortby]"><IMG SRC="/icons/left.gif" BORDER=0 ALT="Pøedchozí strana"></A>
   [ENDIF]
   [IF page]
     strana [page] z [total_page]
   [ENDIF]
   [IF next_page]
     <A HREF="[path_cgi]/review/[list]/[next_page]/[size]/[sortby]"><IMG SRC="/icons/right.gif" BORDER="0" ALT="Dal¹í strana"></A>
   [ENDIF]
  [ENDIF]
  </TD></TR>
  </TABLE>
