...
<TH  ALIGN="left"><FONT COLOR="[bg_color]">Akce</FONT></TH>
...
[FOREACH file IN tpl]
  ...
  [FOREACH translation IN file]
      [IF translation=none]
	<TD BGCOLOR="[bg_color]"><A HREF="[path_cgi]/translate/[file->NAME]/[translation->NAME]">Proveï</A></TD>
      [ELSE]
	<TD><FONT COLOR="[bg_color]">pøelo¾eno</FONT></TD>
      [ENDIF]
  [END]
  </TR>
[END]
