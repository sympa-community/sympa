...
<TD>
  <FORM METHOD="post" ACTION="[path_cgi]">
    <INPUT TYPE="submit" VALUE="Herinner alle abonnees" NAME="action_remind" onClick="return request_confirm('Wilt u echt een herinneringsmail aan alle [total] abonnees sturen?')">
