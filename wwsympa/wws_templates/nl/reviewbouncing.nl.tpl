...
<TD>
  <FORM METHOD="post" ACTION="[path_cgi]">
    <INPUT TYPE="button" VALUE="Herinner alle abonnees" NAME="action_remind" onClick="request_confirm(this.form,'Wilt u echt een herinneringsmail aan alle [total] abonnees sturen?')">
