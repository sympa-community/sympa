...
<TD>
  <FORM METHOD="post" ACTION="[path_cgi]">
    <INPUT TYPE="button" VALUE="Remind all subscribers" NAME="action_remind" onClick="return request_confirm('Do you really want to send a subscription remind message to the [total] subscribers')">
