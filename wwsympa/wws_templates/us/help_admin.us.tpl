...
<!-- begin help_admin.tpl -->
          <LI><FONT COLOR="[dark_color]"><b>Remove list</b></FONT> completely remove the current list. Listmaster privileges are required to <FONT COLOR="[dark_color]"><b>Restore list</b></FONT>.
