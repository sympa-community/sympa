...
<LI>List description : This text is sent as a answer to the mail command
INFO. It can also be included in the <i>Welcome message</I>.

<LI>List homepage : HTML text to describe the list. It is printed in the
right hand side of the main list page.
