...
<TABLE>
 <TR>
   ...
   <TD><img src="/icons/unknown.png" alt="the list name ; be carefull, not its address !"></TD>
 </TR>
 
 <TR>
   <TD NOWRAP><B>Owner:</B></TD>
   <TD><I>[user->email]</I></TD>
   <TD><img src="/icons/unknown.png" alt="You are the privileged owner of this list"></TD>
 </TR>
 ...
 <TR>
  ...
  [END]
    ...
    <TD valign=top><img src="/icons/unknown.png" alt="The list type is a set of parameters' profile. Parameters will be editable, once the list created"></TD>
 </TR>
 <TR>
   <TD NOWRAP><B>Subject:</B></TD>
   <TD><INPUT TYPE="text" NAME="subject" SIZE=60 VALUE="[saved->subject]"></TD>
   <TD><img src="/icons/unknown.png" alt="The list's subject"></TD>
 </TR>
 <TR>
 ...
 <TR>
   ...
   <TD valign=top><img src="/icons/unknown.png" alt="A few lines describing the list"></TD>
 </TR>
