...
<TD>
  <FORM METHOD="post" ACTION="[path_cgi]">
    <INPUT TYPE="button" VALUE="Alle ABonnenten an Passwort erinnern" NAME="action_remind" onClick="request_confirm(this.form,'Wollen Sie wirklich Erinnerungs-EMails an [total] Abonnenten schicken?')">
 ...
 <TD ALIGN="right">
	  ...
	  <A HREF="[path_cgi]/reviewbouncing/[list]/[prev_page]/[size]"><IMG SRC="[icons_url]/left.png" BORDER=0 ALT="Vorherige Seite"></A>
        ...
        [ENDIF]
        [IF next_page]
	  <A HREF="[path_cgi]/reviewbouncing/[list]/[next_page]/[size]"><IMG SRC="[icons_url]/right.png" BORDER=0ALT="N&auml;chste Seite"></A>
        [ENDIF]
    </TD></TR>
