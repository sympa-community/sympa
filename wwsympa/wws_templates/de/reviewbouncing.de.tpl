...
<TD>
  <FORM METHOD="post" ACTION="[path_cgi]">
    <INPUT TYPE="submit" VALUE="Alle ABonnenten an Passwort erinnern" NAME="action_remind" onClick="return request_confirm('Wollen Sie wirklich Erinnerungs-EMails an [total] Abonnenten schicken?')">
