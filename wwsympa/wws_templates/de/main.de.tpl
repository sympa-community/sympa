...
[IF cookie_set]
  ...
  function check_cookie() {
     ...
     if (GetCookie('sympauser') == null) {
        alert("Sympa war nicht in der Lage ein Cookie mit Ihren Login-Informationen zu setzen.\n Sie sollten Ihren Browser so konfigurieren, da&szlig; er Cookies akzeptiert.");
     }
  }
[ENDIF]
