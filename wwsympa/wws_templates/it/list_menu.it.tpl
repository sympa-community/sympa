...
<!-- begin -->
     ...
     <TD BGCOLOR="#330099" VALIGN="top">
      ...
      [IF action=info]
        <TD WIDTH=100% BGCOLOR="#3366cc" NOWRAP align=right>
           <font color="#ffffff" size=-1><b>Informazioni</b></font>
        </TD>
      [ELSE]
 ...
 <TR><!-- for listmaster owner and editor -->
  ...
  <TD WIDTH="70" COLSPAN="2" NOWRAP align=right>
   ...
   [IF action=admin]
        <TD WIDTH="100%" BGCOLOR="#3366cc" NOWRAP align=right><font color="#ffffff" size=-1><b>Amministra</b></font></TD>
   [ELSIF action_type=admin]
        <TD WIDTH="100%" BGCOLOR="#3366cc" NOWRAP align=right>
        <b>
         <A HREF="[path_cgi]/admin/[list]" STYLE="TEXT-DECORATION: NONE"><FONT COLOR="#ffffff" SIZE="-1">Amministra</FONT></A>
        </b>
        </TD>
   [ELSE]
        <TD WIDTH="100%" BGCOLOR="#ccccff" NOWRAP align=right>
    ...
    <TR>
     <TD BGCOLOR="#330099" VALIGN="top">
      ...
      [IF action=suboptions]
        <TD WIDTH="100%" BGCOLOR="#3366cc" NOWRAP align=right><font color="#ffffff" size=-1><b>Opzioni d'iscrizione</b></font></TD>
      [ELSE]
        <TD WIDTH="100%" BGCOLOR="#ccccff" NOWRAP align=right>
        <font size=-1><b>
    ...
    <TR>
     <TD BGCOLOR="#330099" VALIGN="top">
      <TABLE BORDER="0" WIDTH="100%" CELLSPACING="1" CELLPADDING="2" VALIGN="top">
       <TR>
      [IF action=signoff]
        <TD WIDTH="100%" BGCOLOR="#3366cc" NOWRAP align=right><font color="#ffffff" size=-1><b>Cancella iscrizione</b></font></TD>
      [ELSE]
        <TD WIDTH="100%" BGCOLOR="#ccccff" NOWRAP align=right>
        <font size=-1><b>
    ...
    <TR>
     <TD BGCOLOR="#330099" VALIGN="top">
      <TABLE BORDER="0" WIDTH="100%" CELLSPACING="1" CELLPADDING="2" VALIGN="top">
       <TR>
        <TD WIDTH="100%" BGCOLOR="#ccccff" NOWRAP align=right>
        <font size=-1 COLOR="#ffffff"><b>Cancella iscrizione<</b></font>
        </TD>
        <TD WIDTH=40></TD>
       </TR>
      </TABLE>
 ...
 <TR>
  ...
  <TD WIDTH="70" COLSPAN="2" NOWRAP align=right>
   ...
   [IF action=subrequest]
        <TD WIDTH="100%" BGCOLOR="#3366cc" NOWRAP align=right><font color="#ffffff" size=-1><b>Iscrizione</b></font></TD>
   [ELSE]
        <TD WIDTH="100%" BGCOLOR="#ccccff" NOWRAP align=right>
   [IF may_subscribe=1]
        <font size=-1><b>
   ...
   [ELSE]
	<font size=-1 COLOR="#ffffff"><b>Iscrizione</b></font>
   [ENDIF]
        </TD>
   [ENDIF]
 ...
 <TR>
  ...
  <TD WIDTH="70" COLSPAN="2" NOWRAP align=right>
   ...
   [IF action=arc]
        <TD WIDTH="100%" BGCOLOR="#3366cc" NOWRAP align=right>
          <font size=-1 COLOR="#ffffff"><b>Archivio</b></font>
	</TD>
  ...
  <TD WIDTH="70" COLSPAN="2" NOWRAP align=right>
   <TABLE  WIDTH="100%" BORDER="0" CELLPADDING="1" CELLSPACING="2">
    ...
    [ELSE]
      ...
      [ELSE]
        <TD WIDTH="100%" BGCOLOR="#ccccff" NOWRAP align=right>
         <font size=-1 COLOR="#ffffff"><b>Spazio web condiviso</b></font>
        </TD>
      [ENDIF]
    [ENDIF]
