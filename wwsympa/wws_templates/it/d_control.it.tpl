...
<TABLE width=100%>
  ...
  <BR>
   ...
   <INPUT TYPE="submit" NAME="action_d_change_access" VALUE="modifica">
   </FORM>
   ...
   [IF set_owner]
     <TD>
     <B>Modifica il proprietario del documento [path]</B>
     ...
     <INPUT TYPE="submit" NAME="action_d_set_owner" VALUE="Modifica">
     </FORM>
