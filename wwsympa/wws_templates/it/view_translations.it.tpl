...
<TR BGCOLOR="#3366cc">
<TH  ALIGN="left"><FONT COLOR="#ffffff">Azione</TH>
...
[FOREACH file IN tpl]
  ...
  [FOREACH translation IN file]
      [IF translation=none]
	<TD BGCOLOR="#ffffff"><A HREF="[path_cgi]/translate/[file->NAME]/[translation->NAME]">Da tradurre</A></TD>
      [ELSE]
	<TD><FONT COLOR="#ffffff">tradotto</FONT></TD>
      [ENDIF]
  [END]
  </TR>
[END]
