...
<TH  ALIGN="left"><FONT COLOR="[bg_color]">Azione</TH>
...
[FOREACH file IN tpl]
  ...
  [FOREACH translation IN file]
      [IF translation=none]
	<TD BGCOLOR="[bg_color]"><A HREF="[path_cgi]/translate/[file->NAME]/[translation->NAME]">Da tradurre</A></TD>
      [ELSE]
	<TD><FONT COLOR="[bg_color]">tradotto</FONT></TD>
      [ENDIF]
  [END]
  </TR>
[END]
