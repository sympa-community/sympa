...
[ELSE]
  ...
  [ELSE]   
	...
	[IF s->edit]
	  ...
	  <form method="post" ACTION="[path_cgi]">
	  <FONT size=-2>
	  <input type="submit" value="    " name="action_d_delete" onClick="return request_confirm('Vuoi veramente cancellare [path][s->doc] ?')">
	  </FONT>
	...
	<form method="post" ACTION="[path_cgi]">
	<FONT size=-2>
	<input type="submit" value="    " name="action_d_delete" 
