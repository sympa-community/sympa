        ...
        <TABLE BORDER=0 width=100% CELLSPACING=0 CELLPADDING=0>
         <TR BGCOLOR="#ccccff">
          <TD NOWRAP align=center>
     	      ...
     	      <FONT SIZE=-1 COLOR="#3366cc"><b>email <INPUT TYPE=text NAME=email SIZE=20 VALUE="[init_email]">
      	      password : </b>
...
<CENTER>
    ...
    <FONT COLOR="#330099"><B>email</B></FONT> &egrave; il tuo indirizzo con cui ti sei iscritto.
    <FONT COLOR="#330099"><B>password</B></FONT> &egrave; la tua password.<BR><BR>
