...
<TD>
  <FORM METHOD="post" ACTION="[path_cgi]">
    <INPUT TYPE="submit" VALUE="Notifica tutti i sottoscritti" NAME="action_remind" onClick="return request_confirm('Vuoi veramente mandare un messaggio a [total] sottoscritti')">
