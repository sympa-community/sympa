...
<TR BGCOLOR="[light_color]">
          ...
          <TD WIDTH=100%>[list_request_by] <B>in data de</B> [list_request_date]</TD>
</TR>
</TABLE>
</TD>
</TR>
...
<INPUT TYPE="hidden" NAME="serial" VALUE="[list_serial]">
    ...
    <TD> 
      <input type="submit" name="action_install_pending_list" value="Trimite">
      <INPUT TYPE="checkbox" NAME="notify" CHECKED>
      notifica proprietar</FORM> </TD>
</TR>
</TABLE>
<BR><HR><BR>
[ENDIF]
...
<TABLE BORDER=0 WIDTH=100%>
<TR>
    <TD ALIGN=CENTER> <B>Fisier de informare</B> 
[IF is_listmaster] 
([list_info]) 
      [ENDIF] 
</TD>
...
<TR>
    <TD ALIGN=CENTER><B>Fisier de configurare</B> 
[IF is_listmaster] 
([list_config]) 
      [ENDIF] 
</TD>
