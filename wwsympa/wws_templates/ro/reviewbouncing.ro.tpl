...
<TD>
  <FORM METHOD="post" ACTION="[path_cgi]">
        <INPUT TYPE="submit" VALUE="Aminteste tuturor  abonatilor " NAME="action_remind" onClick="return request_confirm('Do you really want to send a subscription remind message to the [total] subscribers')">
