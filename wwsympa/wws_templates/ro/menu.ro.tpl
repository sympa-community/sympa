...
[ENDIF]
 <FONT SIZE=-1><B>Iesi din sistem</B></FONT></A> </TD>
  [ELSE]
 ...
 <A HREF="[path_cgi]/nomenu/loginrequest/referer/[referer]"
     ...
     [ENDIF]
       onClick="window.open('','wws_login','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,width=550,height=300')" TARGET="wws_login"> 
                  <FONT SIZE=-1><B>Autentifica-te</B></FONT></A> </TD>
  [ENDIF]
    </TR>
  </TABLE>
  [ENDIF]
...
<TABLE CELLPADDING=0 CELLSPACING=0 WIDTH="100%" BORDER=0>
  ...
  [IF may_create_list]
   [IF action=create_list_request]
                <TD NOWRAP BGCOLOR="[selected_color]" ALIGN="center"> <FONT SIZE=-1 COLOR=[bg_color] ><B>Creaza 
                  lista</B></FONT> </TD>
   [ELSE]
                <TD NOWRAP BGCOLOR="[light_color]"  ALIGN="center"> <A HREF="[path_cgi]/create_list_request" ><FONT SIZE=-1><B>Creaza 
                  lista</B></FONT></A> </TD>
   [ENDIF]
  [ENDIF]
  ...
  [IF action=pref]
                <TD NOWRAP BGCOLOR="[selected_color]"  ALIGN="center"> <FONT SIZE=-1 COLOR=[bg_color] ><B>Optiuni</B></FONT> 
                </TD>
  [ELSE]
                <TD NOWRAP BGCOLOR="[light_color]"> <A HREF="[path_cgi]/pref/[action]/[list]" ><FONT SIZE=-1><B>Optiuni</B></FONT></A> 
                </TD>
  [ENDIF]

  [IF action=which]
                <TD NOWRAP BGCOLOR="[selected_color]" ALIGN="center"> <FONT SIZE=-1 COLOR=[bg_color] ><B>Inscrierile 
                  tale</B></FONT> </TD>
  [ELSE]
                <TD NOWRAP BGCOLOR="[light_color]" ALIGN="center"> <A HREF="[path_cgi]/which" ><FONT SIZE=-1><B>inscrierila 
                  tales</B></FONT></A> </TD>
   [ENDIF]
  ...
  <TD NOWRAP BGCOLOR="[light_color]" ALIGN="center">
      <FONT SIZE=-1 COLOR=[bg_color] ><B>Pref</B></FONT>
                ...
                <TD NOWRAP BGCOLOR="[light_color]" ALIGN="center"> <FONT SIZE=-1 COLOR="[bg_color]"><b>Inscrierile 
                  tale</b></FONT> </TD>
  [ENDIF]

  [IF action=home]
                <TD NOWRAP BGCOLOR="[selected_color]" ALIGN="center"><FONT SIZE=-1 COLOR=[bg_color]><B>Acasa</B></FONT></TD>
  [ELSE]
                <TD NOWRAP BGCOLOR="[light_color]" ALIGN="center"> <A HREF="[path_cgi]/"><FONT SIZE=-1><B>Acasa</B></FONT></A> 
                </TD>
  [ENDIF]

  [IF action=help]
                <TD NOWRAP BGCOLOR="[selected_color]" ALIGN="center"><FONT SIZE=-1 COLOR=[bg_color]><B>Ajutor</B></FONT></TD>
  [ELSE]
                <TD NOWRAP BGCOLOR="[light_color]" ALIGN="center"> <A HREF="[path_cgi]/help" ><FONT SIZE=-1><B>Ajutor</B></FONT></A> 
                </TD>
  [ENDIF]
</TR>
</TABLE>
