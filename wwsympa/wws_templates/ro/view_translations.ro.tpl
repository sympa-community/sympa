...
<TR BGCOLOR="[selected_color]">
          <TH  ALIGN="left"><FONT COLOR="[bg_color]">Actiuni</font></TH>
...
[FOREACH file IN tpl]
  ...
  [FOREACH translation IN file]
      [IF translation=none]
	      <TD BGCOLOR="[bg_color]"><A HREF="[path_cgi]/translate/[file->NAME]/[translation->NAME]">Fa-o</A></TD>
      [ELSE]
	      <TD><FONT COLOR="[bg_color]">tradus</FONT></TD>
      [ENDIF]
  [END]
  </TR>
[END]
