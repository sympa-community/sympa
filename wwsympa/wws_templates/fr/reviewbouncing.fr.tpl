...
<TD>
  <FORM METHOD="post" ACTION="[path_cgi]">
    <INPUT TYPE="button" VALUE="Rappel des abonnements" NAME="action_remind" onClick="return request_confirm('Êtes-vous sûr de vouloir envoyer un rappel d\'abonnement à chacun des [total] abonnés ?')">
