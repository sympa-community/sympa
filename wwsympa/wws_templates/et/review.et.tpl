...
<TD>
     [PARSE '--ETCBINDIR--/wws_templates/button_header.tpl']
       <TD BGCOLOR="[light_color]" ALIGN="center" VALIGN="top">
         ...
         <A HREF="[path_cgi]/remind/[list]" onClick="request_confirm_link('[path_cgi]/remind/[list]', 'Olete kindel, et soovite saata meeldetuletuse kõigile [total] liikmele ?'); return false;"><b>Meeldetuletus listi liikmetele</b></A>
...
[IF too_many_select]
Liiga palju vastuseid, ei saa näidata
[ENDIF]
[ENDIF]
</FORM>
</TD>
...
<TABLE WIDTH="100%" BORDER="0">
  ...
  <TD NOWRAP>
   ...
   [ENDIF]
   [IF next_page]
     <A HREF="[path_cgi]/review/[list]/[next_page]/[size]/[sortby]"><IMG SRC="[icons_url]/right.png" BORDER="0" ALT="Järgmine leht"></A>
   [ENDIF]
  [ENDIF]
  </TD></TR>
  </TABLE>
	...
	[ENDIF]
        ...
        [IF is_owner]
	  <TH><FONT SIZE="-1"><B>vastuvõtt</B></FONT>
	  </TH>
	  [IF sortby=date]
  	    <TH NOWRAP BGCOLOR="[selected_color]">
