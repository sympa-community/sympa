...
<TH  ALIGN="left"><FONT COLOR="[bg_color]">Tegevused</TH>
...
[FOREACH file IN tpl]
  ...
  [FOREACH translation IN file]
      [IF translation=none]
	<TD BGCOLOR="[bg_color]"><A HREF="[path_cgi]/translate/[file->NAME]/[translation->NAME]">Tõlgi</A></TD>
      [ELSE]
	<TD><FONT COLOR="[bg_color]">tõlgitud</FONT></TD>
      [ENDIF]
  [END]
  </TR>
[END]
