...
[ELSIF action=search_user]
 Aadress <B>[email]</B> on järgnevates listides
[ENDIF]
...
[IF action=which]
[IF ! which]
&nbsp;&nbsp;<FONT COLOR="[dark_color]">Aadress <B>[user->email]</B> ei ole üheski listis!</FONT>
<BR>
[ENDIF]

[IF unique <> 1]
<TABLE>
&nbsp;&nbsp;<FONT COLOR="[dark_color]">Vaata, millistes listides oled järgnevatelt aadressidelt</FONT><BR>
<BR><BR>
...
<TABLE>
<TR>
&nbsp;&nbsp;<FONT COLOR="[dark_color]">Ühenda liikmesaatused aadressile <B>[user->email]</B></FONT><BR> 
