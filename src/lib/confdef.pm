...
our @params = (
    { title => gettext('Directories and file location') },
    {
        name    => 'home',
    ...
    },
    {
        ...
        file    => 'sympa.conf',
        advice  => 'Sympa also locks this file to ensure that it is not running more than once. Caution: user sympa need to write access without special privilege.',
    },
    { 
    ...
    },
   {
    ...
    { title => gettext('General definition') },
    {
        name    => 'domain',
    ...
    },
   {
    ...
    { title => gettext('Errors management') },
    {
        name   => 'bounce_warn_rate',
        sample => '20',
	...
	advice  => 'Type of message that is added a DKIM signature before distribution to subscribers. Possible values are "none", "any" or a list of the following keywords: "md5_authenticated_messages,smime_authenticated_messages,dkim_authenticated_message,editor_validated_message".',
        vhost => '1',
	file   => 'sympa.conf',
    },    
    {
