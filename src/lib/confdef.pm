...
our @params = (
    ...
    },
    {
        ...
        'query'   => gettext('Defines the name of the family the automatic lists are based on.'), 
        'file'    => 'sympa.conf',
        'optional' => '1',
        vhost   => '1',
    },
    {
        ...
        'query'   => gettext('Defines the prefix allowing to recognize that a list is an automatic list.'), 
        'file'    => 'sympa.conf',
        'optional' => '1',
    },
    {
    ...
    },
    {
        ...
        'query'    => gettext('Maximum number of lists listed in "Your lists" menu.  0 lists none.  negative value means unlimited.'),
        'vhost'    => '1',
        'default'  => '10',
    },
