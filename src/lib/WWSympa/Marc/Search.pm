...
sub new {
    my $class = shift;
    my $self  = WWSympa::Marc->new(\%fields);
    bless $self, $class;
    return $self;
}
...
WWSympa::Marc::Search - Search archives of Sympa
...
L<WWSympa::Marc::Search> was originally taken from
