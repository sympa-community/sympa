...
our %pinfo = (
    ...
    title => {    #FIXME:Not specific to web
        context      => [qw(domain site)],
        order        => 1.11,
        'group'      => 'presentation',
    ...
    'owner_domain_min' => {
        ...
        'gettext_comment' =>
            'Minimum number of owners for each list must satisfy the owner_domai
n restriction. The default of zero (0) means *all* list owners must match. Setti
ng to 1 requires only one list owner to match owner_domain; all other owners can
 be from any domain. This setting can be used to ensure that there is always at 
least one known contact point for any mailing list.',
        'format'     => '\d+',
        'length'     => 2,
        'occurrence' => '0-1',
        'default'    => '0',
    ...
    spam_protection => {
        context => [qw(domain site)],    #FIXME: should be derived by list
        order   => 190.61,
        'group' => 'www_other',
